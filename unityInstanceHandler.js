...
function writeMotorPowers() {
    ...
    UnityInstance.SendMessage("RobotManager", "setFrontLeftVel", motors[0]);
    UnityInstance.SendMessage("RobotManager", "setFrontRightVel", motors[1]);
    UnityInstance.SendMessage("RobotManager", "setBackLeftVel", motors[2]);
    UnityInstance.SendMessage("RobotManager", "setBackRightVel", motors[3]);
